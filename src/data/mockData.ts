...
export const mockArticles: NewsArticle[] = [
  {
    ...
    summary: "The European Union has finalized the implementation schedule for its Carbon Border Adjustment Mechanism (CBAM), which will impose tariffs on carbon-intensive imports. The measure aims to prevent carbon leakage while maintaining industrial competitiveness. Multiple trade partners have expressed concerns about compatibility with WTO rules.",
    topic: "Climate",
    sources: 7,
    timeAgo: "2h ago",
    transparencySignals: {
  ...
  },
  {
    ...
    summary: "Federal Reserve Chair indicated that interest rate decisions will remain data-dependent through the first half of 2026. The statement follows mixed economic signals including moderating inflation alongside persistent labor market tightness. Economists remain divided on the timing of potential cuts.",
    topic: "Business",
    sources: 5,
    timeAgo: "4h ago",
    transparencySignals: {
  ...
  },
  {
    ...
    summary: "A Senate committee has voted to advance legislation that would create an independent oversight body for federal infrastructure spending. Supporters argue it increases accountability, while critics question the scope of the proposed agency's authority. The bill now moves to a full Senate vote.",
    topic: "Politics",
    sources: 4,
    timeAgo: "5h ago",
    transparencySignals: {
  ...
  {
    id: "4",
    title: "Global Renewable Energy Investment Surpasses Fossil Fuels for Third Consecutive Quarter",
    summary: "New data from the International Energy Agency shows renewable energy investments have exceeded fossil fuel investments for the third quarter in a row. Solar and wind projects lead the trend, driven by declining manufacturing costs and government incentives across multiple regions.",
    topic: "Climate",
    sources: 6,
    timeAgo: "6h ago",
    transparencySignals: {
  ...
  },
  {
    ...
    summary: "Regulators in multiple jurisdictions are examining whether major technology companies are leveraging existing market positions to dominate emerging artificial intelligence markets. The investigations focus on data access, computing infrastructure, and exclusive partnership agreements.",
    topic: "Business",
    sources: 5,
    timeAgo: "8h ago",
    transparencySignals: {
